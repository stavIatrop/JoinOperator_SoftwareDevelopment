...
SOURCE_MAIN = src/main.c src/radixHashJoin.c src/inputManip.c src/resultListManip.c src/hashing.c src/chainFollower.c src/indexing.c src/indexManip.c src/sideFunctions.c src/H1.c src/functions.c src/interList.c src/jobScheduler.c src/bitVector.c
SOURCE_INPUT_UT = src/inputTesting.c src/inputManip.c src/resultListManip.c
SOURCE_REORDERING_UT = src/viceTests.c src/functions.c src/jobScheduler.c
SOURCE_INDEXING_UT = src/indexTesting.c src/indexManip.c src/hashing.c src/sideFunctions.c
SOURCE_PROJECT_UT = src/projectUnitTest.c src/radixHashJoin.c src/inputManip.c src/resultListManip.c src/hashing.c src/chainFollower.c src/indexing.c src/indexManip.c src/sideFunctions.c src/H1.c src/functions.c src/I_O_structManip.c src/queryManip.c src/jobScheduler.c src/bitVector.c
SOURCE_QUERY_EXECUTE_UT = src/queryExecuteTesting.c src/jointPerformer.c src/radixHashJoin.c src/interList.c src/resultListManip.c src/checksum.c src/indexing.c src/indexManip.c src/sideFunctions.c src/H1.c src/functions.c src/inputManip.c src/hashing.c src/chainFollower.c src/I_O_structManip.c src/queryManip.c src/jobScheduler.c src/bitVector.c
SOURCE_I_O_RECEIVER = src/I_O_Receiver.c src/I_O_structManip.c src/pipeI_O.c src/queryManip.c src/jointPerformer.c src/radixHashJoin.c src/interList.c src/resultListManip.c src/checksum.c src/indexing.c src/indexManip.c src/sideFunctions.c src/H1.c src/functions.c src/inputManip.c src/hashing.c src/chainFollower.c src/jobScheduler.c src/bitVector.c
...
projectUt: $(SOURCE_PROJECT_UT) $(NAME_OF_PROJECT_UT)
	$(CC) -g -O0 -Wall -o  $(NAME_OF_PROJECT_UT) $(SOURCE_PROJECT_UT) -lm -lcunit -pthread
	@echo Compiled Project Unit tests
	@echo 

searchListUt: $(SOURCE_SEARCH_LIST_UT) $(NAME_OF_SEARCH_LIST_UT)
	$(CC) -g -O0 -Wall -o  $(NAME_OF_SEARCH_LIST_UT) $(SOURCE_SEARCH_LIST_UT) -lm -lcunit -pthread
	@echo Compiled Search and List Unit tests
	@echo 

inputUtTarget: $(SOURCE_INPUT_UT) $(NAME_OF_INPUT_UT)
	$(CC) -g -O0 -Wall -o  $(NAME_OF_INPUT_UT) $(SOURCE_INPUT_UT) -lm -lcunit -pthread
	@echo Compiled Input Unit Test
	@echo 

reorderingUtTarget: $(SOURCE_REORDERING_UT) $(NAME_OF_REORDERING_UT)
	$(CC) -g -O0 -Wall -o  $(NAME_OF_REORDERING_UT) $(SOURCE_REORDERING_UT) -lm -lcunit -pthread
	@echo Compiled Reordering Unit Test
	@echo

indexingUt: $(SOURCE_INDEXING_UT) $(NAME_OF_INDEXING_UT)
	$(CC) -g -O0 -Wall -o  $(NAME_OF_INDEXING_UT) $(SOURCE_INDEXING_UT) -lm -lcunit -pthread
...
mainTarget: $(SOURCE_MAIN) $(NAME_OF_MAIN)
	$(CC) -g -O0 -Wall -o  $(NAME_OF_MAIN) $(SOURCE_MAIN) -lm -lcunit -pthread
	@echo Compiled Main
	@echo
...
$(NAME_OF_PROJECT_UT): $(OBJECT_PROJECT_UT)
	$(CC) -g  -O0 $(OBJECT_PROJECT_UT) -o $@ -lm -lcunit -pthread

$(NAME_OF_SEARCH_LIST_UT): $(OBJECT_SEARCH_LIST_UT)
	$(CC) -g  -O0 $(OBJECT_SEARCH_LIST_UT) -o $@ -lm -lcunit -pthread

$(NAME_OF_MAIN): $(OBJECT_MAIN)
	$(CC) -g  -O0 $(OBJECT_MAIN) -o $@ -lm -lcunit -pthread

$(NAME_OF_INPUT_UT): $(OBJECT_INPUT_UT)
	$(CC) -g  -O0 $(OBJECT_INPUT_UT) -o $@ -lm -lcunit -pthread

$(NAME_OF_REORDERING_UT): $(OBJECT_REORDERING_UT)
	$(CC) -g  -O0 $(OBJECT_REORDERING_UT) -o $@ -lm -lcunit -pthread

$(NAME_OF_INDEXING_UT): $(OBJECT_INDEXING_UT)
	$(CC) -g  -O0 $(OBJECT_INDEXING_UT) -o $@ -lm -lcunit -pthread
