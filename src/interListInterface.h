...
void updateInterAndDelete2(headInter * headInt, nodeInter * node1, nodeInter * node2, headResult * headRes, myint_t, myint_t, myint_t, char switched);
...
myint_t ** joinRowIds2(nodeInter * node1, nodeInter * node2, headResult * headRes, myint_t *results, char switched);
